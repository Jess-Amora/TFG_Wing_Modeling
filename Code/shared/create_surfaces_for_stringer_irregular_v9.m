function [quad_surfaces,tri_surfaces, warnings, combined_nodes] = create_surfaces_for_stringer_irregular_v9( ...
...
%   warnings: Cell array with warnings about skipped or invalid surfaces.
    ...
    [combined_nodes, Inserted_node] = add_perpendicular_node_to_front_spar_v0(combined_nodes, stringer_index, geometria,datosEstructural);
