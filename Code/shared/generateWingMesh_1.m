function mesh = generateWingMesh_1(geom_struct, rib_struct, datosEstructural, avion)
...
%
    ...
    %    pendiente_post, geom_struct.pendiente_perp, Numero_nodos_dos_largueros, delta_larguerillo, alfa, threshold_distance);
