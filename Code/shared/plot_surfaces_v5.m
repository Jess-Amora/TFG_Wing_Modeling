function plot_surfaces_v5(combined_nodes, inserted_table, quad_surfaces, tri_surfaces, penta_surfaces, rear_surfaces, plottitle, plotfilename,avion,datosEstructural)
...
% Flag graph
    ...
    for i = 1:height(inserted_table)
        text(inserted_table.x(i), inserted_table.y(i), sprintf('%d', inserted_table.local_id(i)), ...
             'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'right', 'FontSize', 8, 'Color', 'black');
    end
