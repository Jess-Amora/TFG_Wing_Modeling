function plot_stringer_regular_surfaces_v2(combined_nodes, quad_surfaces_regular, plottitle, plotfilename)
...
%   plotfilename: Path to save the resulting plot (optional)
    ...
    if ~isempty(quad_surfaces_regular)
        for i = 1:height(quad_surfaces_regular)
            ...
            % Ensure nodes are ordered top-left, bottom-left, bottom-right, top-right
            ordered_coords = [
                ...
                surface_nodes.y(surface_nodes.local_id == quad_surfaces_regular.node_2(i)); % Bottom-left (node_2)
                surface_nodes.x(surface_nodes.local_id == quad_surfaces_regular.node_3(i)), ...
                surface_nodes.y(surface_nodes.local_id == quad_surfaces_regular.node_3(i)); % Bottom-right (node_3)
