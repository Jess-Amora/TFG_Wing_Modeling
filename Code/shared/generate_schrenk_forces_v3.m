function forces = generate_schrenk_forces_v3(Vector_nodos, b, L_total)
% GENERATE_SCHRENK_FORCES: Computes and distributes Schrenk forces on front and rear spars.
    ...
    for i = 1:num_nodes
        ...
        forces = [forces; table(2, combined_nodes.global_id(i), "FORCE", force_magnitude, ...
