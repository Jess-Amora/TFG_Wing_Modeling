function plot_rear_spar_surfaces(combined_nodes, superficie_horizontal_larguero_posterior, plottitle, plotfilename)
...
%   plotfilename: Path to save the resulting plot
    ...
    disp('✅ Rear spar surfaces plot completed and saved successfully.');
end
