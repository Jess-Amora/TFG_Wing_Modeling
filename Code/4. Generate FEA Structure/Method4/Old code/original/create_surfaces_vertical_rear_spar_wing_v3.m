...
%   warnings - Cell array containing warnings for skipped or invalid surfaces.
    ...
    for i = 1:min(height(rear_spar_extrados), height(rear_spar_intrados)) - 1 
        ...
        quad_surfaces = append_quad_surface_rear(quad_surfaces, nodes, surface_counter, "quad vertical rear spar", area, aspect_ratio);
        surface_counter = surface_counter + 1;
    end
end

function quad_surfaces = append_quad_surface_rear(quad_surfaces, nodes, surface_counter, tag, area, aspect_ratio)
