...
addpath("4. Generate FEA Structure\Method4")
...
combined_nodes_3D = generate_3D_nodes(combined_nodes, combined_nodes_fuselaje, avion.perfil.airfoil );
...
results.quad.quad_irregular_wing_wing = quad_irregular_wing_wing;
