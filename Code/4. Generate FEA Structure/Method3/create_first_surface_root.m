...
%       - tags: Description of the surface type.
...
%   warnings - Cell array containing warnings about missing or invalid nodes.
    ...
    if ~isempty(current_stringer_nodes) && ~isempty(next_stringer_nodes)
        ...
        stringer_1 = -2;  % Rear spar
        stringer_2 = 1;   % First stringer
        rib_1 = -1;       % Root rib
        rib_2 = start_rib;        % Adjacent rib
        tag = "tri corner root";
...
% 🔹 **OUTPUT STRUCTURE**
%
% | local_id | node_1 | node_2 | node_3 | stringer_1 | stringer_2 | rib_1 | rib_2 | tags            | area  | aspect_ratio |
% |----------|--------|--------|--------|------------|------------|-------|-------|----------------|-------|--------------|
