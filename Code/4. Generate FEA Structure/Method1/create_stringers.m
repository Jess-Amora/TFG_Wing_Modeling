function [horizontal_stringers,vertical_stringers,lines_spars] = create_stringers(combined_nodes_3D)
...
% 
% end
% Extract unique rib numbers from rib_ranges_by_ribs
...
for i = 1:2:length(unique_ribs)
    ...
    % De arriba para abajo el sentido de la barra
    [larguerillo_i, line_counter] = create_lines_from_stringer_vertical(Vector_extrados, Vector_intrados, current_rib, "barra costilla", "vertical", 1);
    vertical_stringers = [vertical_stringers; larguerillo_i];
end
