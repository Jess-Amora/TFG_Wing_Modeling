...
% CREATE_SURFACES_REAR_SPAR_WING - Generates quadrilateral surfaces for the rear spar in the wing.
%
% Inputs:
...
%   warnings - Cell array containing warnings for skipped or invalid surfaces.
    ...
    for i = 1:min(height(rear_spar_extrados), height(rear_spar_intrados)) - 1 
        ...
        quad_surfaces = append_quad_surface(quad_surfaces, nodes, surface_counter, "quad vertical rear", area, aspect_ratio);
