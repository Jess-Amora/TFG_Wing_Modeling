    ...
    if ~isempty(current_stringer_nodes) && ~isempty(next_stringer_nodes)
        ...
        elseif(case_penta)
            ...
            quad_surfaces = [quad_surfaces; table( ...
                ...
                3e5, ...                % rib_1
                start_rib, ...            % rib_2
                "quad irregular root P2 inserted", ...       % tag
                area, ...                   % area
                aspect_ratio, ...           % aspect_ratio
                'VariableNames', {'local_id', 'node_1', 'node_2', 'node_3', 'node_4', ...
                                  'stringer_1', 'stringer_2', 'rib_1', 'rib_2', 'tag', ...
            ...
            quad_surfaces = [quad_surfaces; table( ...
                ...
                start_rib-1, ...                % rib_1
                3e5, ...            % rib_2
                "quad irregular root P3 inserted", ...       % tag
                area, ...                   % area
                aspect_ratio, ...           % aspect_ratio
                'VariableNames', {'local_id', 'node_1', 'node_2', 'node_3', 'node_4', ...
                                  'stringer_1', 'stringer_2', 'rib_1', 'rib_2', 'tag', ...
...
% 🔹 **OUTPUT STRUCTURE**
%
% | local_id | node_1 | node_2 | node_3 | node_4 | stringer_1 | stringer_2 | rib_1 | rib_2 | tag                  | area  | aspect_ratio |
% |----------|--------|--------|--------|--------|------------|------------|-------|-------|----------------------|-------|--------------|
