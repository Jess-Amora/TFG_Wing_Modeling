...
%   line_counter      - Updated line counter after adding all lines.
    ...
    quad_surfaces_ala = quad_initialize();
    quad_surfaces_fuselaje = quad_initialize();
    warnings = {};
    surface_counter = 1;
...
for index_rib = 1:2:max_rib_index
    ...
    disp(quad_initialize.Properties.VariableNames);
    disp(quad_surfaces_rib.Properties.VariableNames);
