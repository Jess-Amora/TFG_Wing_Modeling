...
for index_larguerillo = 1:max_stringer_index
    ...
    larguerillo_wing = order_lines_by_coordinates_v2(larguerillo_wing,1.5);
...
cordon_wing_extrados = order_lines_by_coordinates_v2(cordon_wing_extrados,1.5);

cordon_wing_intrados = combined_nodes_3D(combined_nodes_3D.tag=='front spars' & combined_nodes_3D.h == 'intrados',:);
cordon_wing_intrados = order_lines_by_coordinates_v2(cordon_wing_intrados,1.5);
