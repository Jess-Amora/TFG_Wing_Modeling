function main_write_structure(avion,predimData,database_computer)
...
write_bdf_quads(fullfile(avion.folder.data,"\quads_vertical_spars.bdf"), quad_vertical_3D_processed, [], p_shell_vertical, mat_vertical);
