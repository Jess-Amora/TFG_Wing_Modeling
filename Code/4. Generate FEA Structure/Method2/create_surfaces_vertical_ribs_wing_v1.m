function [quad_surfaces, warnings] = create_surfaces_vertical_ribs_wing_v1(combined_nodes_3D)
    ...
    front_spar_extrados = sortrows(combined_nodes_3D(combined_nodes_3D.tag == 'front spars' & ...
                                   combined_nodes_3D.h == 'extrados', :), 5);
    front_spar_intrados = sortrows(combined_nodes_3D(combined_nodes_3D.tag == 'front spars' & ...
                                   combined_nodes_3D.h == 'intrados', :), 5);

    rear_spar_extrados = sortrows(combined_nodes_3D(combined_nodes_3D.tag == 'rear spars' & ...
                                  combined_nodes_3D.h == 'extrados', :), 5);
    rear_spar_intrados = sortrows(combined_nodes_3D(combined_nodes_3D.tag == 'rear spars' & ...
                                  combined_nodes_3D.h == 'intrados', :), 5);
