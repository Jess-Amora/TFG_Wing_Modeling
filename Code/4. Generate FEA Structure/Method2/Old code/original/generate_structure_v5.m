...
for index_larguerillo = 1:max_stringer
    ...
    % [tri_surfaces_stringer, quad_surfaces_stringer, warnings_i, combined_nodes] = create_surfaces_root_test1(combined_nodes, index_larguerillo,ala.geometria, datosEstructural);
    tri_root = [tri_root; tri_surfaces_stringer];
...
forces_front = generate_schrenk_forces_v4(front_spar_extrados, avion.geometria.b, L_total);
forces_rear = generate_schrenk_forces_v4(rear_spar_extrados, avion.geometria.b, L_total);
