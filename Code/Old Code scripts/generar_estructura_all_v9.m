...
% Regular
plottitle = strcat('Verification Plot for All Region with regular rectangular surfaces');
plotfilename = strcat('../Results/Figures/REGULAR_ALL_v3_generate_structure_v9_ala12_a350_1000_datos_estructual');
% plot_stringer_regular_surfaces_v3(combined_nodes, [quad_surfaces_regular; quad_rectangular_regular],plottitle, plotfilename,avion,datosEstructural);
...
% plot_surfaces_v1(combined_nodes, inserted_table, ...
%     [quad_surfaces_regular;quad_rectangular_regular;quad_irregular] ...
%     , [], [],superficie_horizontal_larguero_posterior, plottitle, plotfilename)

% Regular + Irregular quad
plottitle = strcat('Verification Plot for Irregular Region with irregular surfaces');
plotfilename = strcat('../Results/Figures/ALLRegularandIrregular_generate_structure_v6_ala12_a350_1000_datos_estructual');
% plot_stringer_irregular_surfaces(combined_nodes, inserted_table, [quad_surfaces_regular;quad_rectangular_regular;quad_irregular],plottitle, plotfilename,avion,datosEstructural);

% All quad regular/irregular, tri, penta
plottitle = strcat('Verification Plot');
plotfilename = strcat('../Results/Figures/plot_surfaces_v1_generate_structure_v9_ala13_a350_1000_datos_estructual');
OnlyQuads = [quad_surfaces_regular;quad_rectangular_regular;quad_irregular;quad_root];
% plot_surfaces_v1(combined_nodes, inserted_table, ...
%     [OnlyQuads], [tri_surfaces;tri_root], [penta_root],[superficie_horizontal_larguero_posterior], plottitle, plotfilename)

% All quad regular/irregular, tri, penta
plottitle = strcat('Verification Plot');
plotfilename = strcat('../Results/Figures/plot_surfaces_v3_generate_structure_v9_ala13_a350_1000_datos_estructual');
OnlyQuads = [quad_surfaces_regular;quad_rectangular_regular;quad_irregular;quad_root];
% plot_surfaces_v3(combined_nodes, inserted_table, ...
%     [OnlyQuads], [tri_surfaces;tri_root], [penta_root],[superficie_horizontal_larguero_posterior], plottitle, plotfilename)
