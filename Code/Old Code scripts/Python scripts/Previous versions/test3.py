...
def main():
    ...
    points_csv = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Matlab\main\mesh\points.csv"  # Replace with actual path
    elements_csv = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Matlab\main\mesh\\elements.csv"  # Replace with actual path

    # Path to output STEP file
    step_output = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Matlab\main\mesh\output_model.step"  # Replace with actual path
