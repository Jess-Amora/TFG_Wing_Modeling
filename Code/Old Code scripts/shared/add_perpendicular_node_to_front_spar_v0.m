function [combined_nodes, Inserted_node] = add_perpendicular_node_to_front_spar_v0(combined_nodes, stringer_index, geometria, datosEstructural)
...
%   Inserted_node: The new node added to the structure.
    ...
    alfa_larguero_posterior_radianes = geometria.alfa_larg_posterior;  % Rear spar angle (rad)
    pendiente_perpendicular_larguero_posterior = geometria.pendiente_perp;  % Perpendicular slope to rear spar
