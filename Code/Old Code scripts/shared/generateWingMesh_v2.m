function mesh = generateWingMesh_v2(geom, costillas, costilla_medios, datosEstructural, avion)
...
%
    ...
    pendiente_perp = geom.pendiente_perp;
    ...
    intersecciones_costillas_larguerillos = cortes_de_dos_funciones_lineales_v3(squeeze(larguerillos(:,:,1)),pendiente_post,costilla_medios(:,1:2),pendiente_perp);
