function [results] = generate_wing_v8(avion, cargas)
...
%
    ...
    ribs_struct = generateCostillas(geom, datosEstructural, cargas, avion);
    ...
    mesh = generateWingMesh_v0(geom, costillas, larguerillos, datosEstructural, avion);
...
%% ------------------------------------------------------------------------
function geom = computeStructuralGeometry_v0(avion)
...
%
    ...
    plotStructuralGeometry_v0(geom, avion);
end
