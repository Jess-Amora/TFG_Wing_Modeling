function OnlyPlotSurface_v5(combined_nodes_3D, inserted_table, quad_surfaces, tri_surfaces, penta_surfaces, rear_surfaces, plottitle, plotfilename,avion,datosEstructural)
...
%
% Inputs:
%   combined_nodes_3D: Table with columns [local_id, x, y, rib_index, stringer_index, tag].
...
%% cálculos previo
[num_stringers_last_rib, max_rib_index, max_stringer_index, rib_ranges, special_rib_indices] = analyze_stringer_rib_data_v2(combined_nodes_3D);
%% 🎯 Initialize Plot
...
%% 🟢 Plot Nodes Wing
% Identify node tags
front_spar_idx = strcmp(combined_nodes_3D.tag, 'front spars');
rear_spar_idx = strcmp(combined_nodes_3D.tag, 'rear spars');
stringer_idx = strcmp(combined_nodes_3D.tag, 'stringer');

front_spar_dots = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'front spars'),:);
rear_spar_dots = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'rear spars'),:);
stringer_dots = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'stringer'),:);

% Plot nodes with unique markers and colors
front_spar_points = plot3(combined_nodes_3D.x(front_spar_idx), combined_nodes_3D.y(front_spar_idx), ...
     'ro', 'MarkerSize', 4, 'MarkerFaceColor', 'r', 'DisplayName', 'Front Spar Nodes');
rear_spar_points = plot3(combined_nodes_3D.x(rear_spar_idx), combined_nodes_3D.y(rear_spar_idx), ...
     'bo', 'MarkerSize', 4, 'MarkerFaceColor', 'b', 'DisplayName', 'Rear Spar Nodes');
stringer_points = plot3(combined_nodes_3D.x(stringer_idx), combined_nodes_3D.y(stringer_idx), ...
     'ko', 'MarkerSize', 4, 'MarkerFaceColor', 'k', 'DisplayName', 'Stringer Nodes');
inserted_table_points = plot3(inserted_table.x, inserted_table.y, ...
...
%% 🟢 Plot Nodes Fuselaje
% Identify node tags
front_spar_idx_fuselaje = strcmp(combined_nodes_3D.tag, 'front spars fuselaje');
rear_spar_idx_fuselaje = strcmp(combined_nodes_3D.tag, 'rear spars fuselaje');
stringer_idx_fuselaje = strcmp(combined_nodes_3D.tag, 'stringer fuselaje');

front_spar_dots_fuselaje = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'front spars fuselaje'),:);
rear_spar_dots_fuselaje = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'rear spars fuselaje'),:);
stringer_dots_fuselaje = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'stringer fuselaje'),:);

% Plot nodes with unique markers and colors
front_spar_points_fuselaje = plot(combined_nodes_3D.x(front_spar_idx_fuselaje), combined_nodes_3D.y(front_spar_idx_fuselaje), ...
     'ro', 'MarkerSize', 4, 'MarkerFaceColor', 'r', 'DisplayName', 'Front Spar Nodes');
rear_spar_points_fuselaje = plot(combined_nodes_3D.x(rear_spar_idx_fuselaje), combined_nodes_3D.y(rear_spar_idx_fuselaje), ...
     'bo', 'MarkerSize', 4, 'MarkerFaceColor', 'b', 'DisplayName', 'Rear Spar Nodes');
stringer_points_fuselaje = plot(combined_nodes_3D.x(stringer_idx_fuselaje), combined_nodes_3D.y(stringer_idx_fuselaje), ...
     'ko', 'MarkerSize', 4, 'MarkerFaceColor', 'k', 'DisplayName', 'Stringer Nodes');
...
if ~isempty(quad_surfaces)
    for i = 1:height(quad_surfaces)
        ...
        if strcmp(surface_tag, "quad irregular P1 inserted")
            % P1 from inserted_table, other nodes from combined_nodes_3D
            node_1 = inserted_table(inserted_table.local_id == quad_surfaces.node_1(i), :);
            node_2 = combined_nodes_3D(combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i) & combined_nodes_3D.rib_index ==-2, :);
            node_3 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_3(i) & strcmp(combined_nodes_3D.tag, 'front spars'), :);
            node_4 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_4(i), :);

        elseif strcmp(surface_tag, "quad irregular P4 inserted")
            % P4 from inserted_table, other nodes from combined_nodes_3D
            node_1 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_1(i), :);
            node_2 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_2(i), :);
            node_3 = combined_nodes_3D(combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i) & combined_nodes_3D.rib_index ==-2, :);
        ...
        elseif strcmp(surface_tag, "quad irregular")
            ...
            node_1 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_1(i), :);
            node_2 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_2(i) & strcmp(combined_nodes_3D.tag, 'front spars'), :);
            node_3 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_3(i) & strcmp(combined_nodes_3D.tag, 'front spars'), :);
            node_4 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_4(i), :);
        elseif strcmp(surface_tag, "quad regular")
            % P2 and P3 from front spar nodes
            node_1 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_1(i)& strcmp(combined_nodes_3D.tag, 'stringer'), :);
            node_2 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_2(i)& strcmp(combined_nodes_3D.tag, 'stringer'), :);
            node_3 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_3(i)& strcmp(combined_nodes_3D.tag, 'stringer'), :);
            node_4 = combined_nodes_3D(combined_nodes_3D.local_id == quad_surfaces.node_4(i)& strcmp(combined_nodes_3D.tag, 'stringer'), :);
        elseif strcmp(surface_tag, "quad irregular root")
            % Extract nodes
            node_1 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == -1 & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_1(i), :); % Bottom-left
            
            node_2 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == -1 & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i), :); % Bottom-right
            
            node_3 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_2(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i), :); % Top-right
            
            node_4 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_2(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_1(i), :); % Top-left
        elseif strcmp(surface_tag, "quad irregular root corner")

            % Extract nodes
            node_1 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_1(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_1(i), :); % Bottom-left
        ...
        elseif strcmp(surface_tag, "quad OnlyNode1")
            ...
            node_2 = combined_nodes_3D( ...
                combined_nodes_3D.local_id == 1 & ...
                combined_nodes_3D.tag == 'OnlyNode', :); % Bottom-right
        ...
        elseif strcmp(surface_tag, "quad fuselaje front root")
            ...
            node_3 = combined_nodes_3D(combined_nodes_3D.local_id == 1 & combined_nodes_3D.tag == 'OnlyNode', :); % Top-right
            
            node_4 = combined_nodes_3D(combined_nodes_3D.rib_index == -1 & combined_nodes_3D.stringer_index == max_stringer_index, :); % Top-left
        ...
        elseif strcmp(surface_tag, "quad fuselaje rear root")
            ...
            num_ribs = height(combined_nodes_3D(combined_nodes_3D.stringer_index == 1, :))-1;

            node_1 = combined_nodes_3D(combined_nodes_3D.rib_index == num_ribs & combined_nodes_3D.tag == 'rear spars fuselaje', :);          % Top-left

            node_2 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_1(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i), :); % Bottom-right

            node_3 = combined_nodes_3D(combined_nodes_3D.rib_index == -1 & combined_nodes_3D.stringer_index == 1, :); % Top-right

            node_4 = combined_nodes_3D(combined_nodes_3D.rib_index == start_rib & combined_nodes_3D.tag == 'rear spars', :); % Top-left
        ...
        elseif strcmp(surface_tag, "quad fuselaje rear")
            ...
            node_1 = combined_nodes_3D(combined_nodes_3D.rib_index == quad_surfaces.rib_1(i) & combined_nodes_3D.tag == 'rear spars fuselaje', :);          % Top-left
            ...
            node_4 = combined_nodes_3D(combined_nodes_3D.rib_index == quad_surfaces.rib_2(i) & combined_nodes_3D.tag == 'rear spars fuselaje', :);          % Top-left
         ...
         elseif strcmp(surface_tag, "quad fuselaje root")
            ...
            node_1 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_1(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_1(i), :); % Bottom-right

            node_2 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == quad_surfaces.rib_1(i) & ...
                combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i), :); % Bottom-right

            node_3 = combined_nodes_3D(combined_nodes_3D.rib_index == -1 & combined_nodes_3D.stringer_index == quad_surfaces.stringer_2(i), :);

            node_4 = combined_nodes_3D(combined_nodes_3D.rib_index == -1 & combined_nodes_3D.stringer_index == quad_surfaces.stringer_1(i), :);
        ...
        switch surface_tag
            case "tri front"
                ...
                node_1 = combined_nodes_3D( ...
                    ...
                    combined_nodes_3D.stringer_index == tri_surfaces.stringer_1(i), :); % Bottom-left

                node_2 = find_max_rib_node(combined_nodes_3D, tri_surfaces.stringer_1(i)); % Bottom-right

                node_3 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == node_2.rib_index & ...
                    strcmp(combined_nodes_3D.tag, 'front spars'), :); % Top (on front spar)
            ...
            case "tri corner root"
                stringer_index =1;
                current_stringer_nodes = combined_nodes_3D( ...
                    combined_nodes_3D.stringer_index == stringer_index, :);
            
                next_stringer_nodes = combined_nodes_3D( ...
                    combined_nodes_3D.stringer_index == stringer_index + 1, :);
            
                start_rib = rib_ranges(1,2);

                % Triangulo
                node_1 = current_stringer_nodes(current_stringer_nodes.rib_index == start_rib, :);
                node_2 = combined_nodes_3D(combined_nodes_3D.tag =='rear spars' & combined_nodes_3D.rib_index == start_rib,:); % Bottom-left
            ...
            case "tri root"
                ...
                node_1 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == tri_surfaces.rib_2(i) - 1 & ...
                    combined_nodes_3D.stringer_index == tri_surfaces.stringer_2(i), :); % Bottom-left

                node_2 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == tri_surfaces.rib_2(i) - 1 & ...
                    strcmp(combined_nodes_3D.tag, 'rear spars'), :); % Bottom-right

                node_3 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == -1 & ...
                    combined_nodes_3D.stringer_index == tri_surfaces.stringer_2(i), :); % Top
            ...
            case "tri last front"
                ...
                node_1 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index ==  - 2 & ...
                    combined_nodes_3D.stringer_index == max_stringer_index, :); 

                node_2 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index ==  rib_ranges(max_stringer_index,3) & ...
                    combined_nodes_3D.stringer_index == max_stringer_index, :); 

                node_3 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index ==  rib_ranges(max_stringer_index,3) & ...
                    combined_nodes_3D.tag == 'front spars', :); % Top
...
if ~isempty(rear_surfaces)
    for i = 1:height(rear_surfaces)
        ...
        rear_spar_nodes = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'rear spars'), :);
        stringer_nodes = combined_nodes_3D(strcmp(combined_nodes_3D.tag, 'stringer') & combined_nodes_3D.stringer_index == 1, :);
...
if ~isempty(penta_surfaces)
    for i = 1:height(penta_surfaces)
        ...
        if strcmp(surface_tag, "penta root")
            node_1 = combined_nodes_3D( ...
            combined_nodes_3D.rib_index == -1 & ...
            combined_nodes_3D.stringer_index == penta_surfaces.stringer_1(i), :); % Bottom-left
        
            node_2 = combined_nodes_3D( ...
                        combined_nodes_3D.rib_index == penta_surfaces.rib_2(i) - 1 & ...
                        strcmp(combined_nodes_3D.tag, 'rear spars'), :); % Bottom-right
            
            node_3 = combined_nodes_3D( ...
                        combined_nodes_3D.rib_index == penta_surfaces.rib_2(i) - 1 & ...
                        combined_nodes_3D.stringer_index == penta_surfaces.stringer_2(i), :); % Top-right
            
            node_4 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == penta_surfaces.rib_2(i) & ...
                combined_nodes_3D.stringer_index == penta_surfaces.stringer_2(i), :); % Top-left
            
            node_5 = combined_nodes_3D( ...
                combined_nodes_3D.rib_index == penta_surfaces.rib_2(i) & ...
                combined_nodes_3D.stringer_index == penta_surfaces.stringer_1(i), :); % Top
            
        elseif strcmp(surface_tag, "penta front")
            % P4 from inserted_table, other nodes from combined_nodes_3D
            node_1 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == penta_surfaces.rib_1(i) & ...
                    combined_nodes_3D.stringer_index == penta_surfaces.stringer_1(i), :); % Bottom-left

            node_2 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == penta_surfaces.rib_1(i) & ...
                    combined_nodes_3D.stringer_index == penta_surfaces.stringer_2(i), :); % Bottom-left
            ...
            node_4 = combined_nodes_3D( ...
                    combined_nodes_3D.rib_index == penta_surfaces.rib_2(i)  & ...
                    strcmp(combined_nodes_3D.tag, 'front spars'), :); % Bottom-right
