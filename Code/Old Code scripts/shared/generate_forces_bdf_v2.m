function generate_forces_bdf_v2(filename, forces, nodes_table)
% GENERATE_FORCES_BDF_V2: Generates a .bdf file for forces and moments applied to nodes.
%
% Inputs:
    ...
    for load_id = unique_load_ids'
        ...
        for i = 1:height(current_forces)
            ...
            force_line = sprintf('%-8s%8d%8d%8d%16.6f%16.6f%16.6f%16.6f\n', ...
                                 type, load_id, node_id, 0, magnitude, dir_x, dir_y, dir_z);
