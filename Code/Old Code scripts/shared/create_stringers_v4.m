function [horizontal_stringers,vertical_stringers] = create_stringers_v4(combined_nodes_3D)
...
OnlyNode = combined_nodes_3D(combined_nodes_3D.tag=='front spars' & combined_nodes_3D.h == 'intrados' & combined_nodes_3D.rib_index == 1e5,:);
cordon_anterior = [cordon_fuselage(1:end-1,:); OnlyNode ; cordon_wing];
