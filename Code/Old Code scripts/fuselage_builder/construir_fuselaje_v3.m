function [results] = construir_fuselaje_v3(avion,datosEstructural, ala,output_command)
...
% Parámetros de entrada:
    ...
    intersecciones_costillas_larguerillos = cortes_de_dos_funciones_lineales(squeeze(costilla_costilla_medio_fuselaje(:,:,1)),inf,squeeze(larguerillos_fuselaje(:,:,1)),0);
    ...
    for i = 1 : Numero_nodos_elementos_fuselaje(2,1)-1
        % Numero_nodos_elementos_fuselaje(2,1)
        barras_fuselaje_larguero_anterior = [barras_fuselaje_larguero_anterior [Numero_nodos_elementos_fuselaje(1,1)+i;Numero_nodos_elementos_fuselaje(1,1)+i+1]];
    end
    ...
    for index_larguerillo_counter = 1:numero_larguerillos_total % El bucle para cada larguerillo
        ...
        temp_node = sum(Numero_nodos_elementos_fuselaje(1:index_larguerillo_counter+1,1));
