...
% Convert nodos_larguerillos to a table
...
superficie_horizontal_larguero_pasterior = create_rear_spar_surfaces_v3(...
    nodos_larguerillos_table, start_rib, end_rib, TEMP_ID_BASE_larguero_posterior);
% 
% plottitle = strcat('Verification Plot for rear spar surface Region');
% plotfilename = strcat('../Results/Figures/plot_surfaces_verification_v5_rear_spar_ala12_TFG_Amora_aviones_a350_1000_datos_estructual');
% plot_surfaces_verification_v5(nodos_larguerillos_table, superficie_horizontal_larguero_pasterior, [],nodos_anterior_ala_table,nodos_posterior_ala_table, ...
%     'rear spar',plottitle, plotfilename);
...
% plot_surfaces_verification_v5(nodos_larguerillos_table, quad_surfaces_regular, tri_surfaces_regular,nodos_anterior_ala_table,nodos_posterior_ala_table, ...
...
plot_surfaces_verification_v5(nodos_larguerillos_table, quad_surfaces_irregular, tri_surfaces_irregular,nodos_anterior_ala_table,nodos_posterior_ala_table, ...
...
plot_surfaces_verification_v5(nodos_larguerillos_table, quad_all, tri_all,nodos_anterior_ala_table,nodos_posterior_ala_table, ...
    'irrregular',plottitle, plotfilename);
