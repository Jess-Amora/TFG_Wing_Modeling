function plotAla2Dcostilla_fuselaje(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costilla_fuselaje.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costilla_fuselaje.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_costilla_fuselaje.png')]);
    end
