function plotAla2Dcostilla_fuselaje(avion, ax, closeflag)
    ...
    if nargin < 2 || isempty(ax)
        fig = figure('Name', 'Costilla Fuselaje', 'NumberTitle', 'off');
        ax = gca;
    else
    ...
    ylabel(ax, 'Y (Cuerda)');
    title(ax, 'Distribución de las Costillas en el Fuselaje');
