function plotAla2D_costillas_larguerillo_fuselaje(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas_larguerillos_fuselaje.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas_larguerillos_fuselaje.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_costillas_larguerillos_fuselaje.png')]);
    end
