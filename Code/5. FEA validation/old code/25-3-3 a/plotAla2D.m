...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig1, fullfile(avion.folder.figures, 'Plot_geometria.png'));
        saveas(fig1, fullfile(avion.folder.figures, 'Plot_geometria.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_geometria.png')]);
    end
