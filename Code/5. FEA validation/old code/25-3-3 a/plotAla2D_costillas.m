function plotAla2D_costillas(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_costillas.png')]);
    end
