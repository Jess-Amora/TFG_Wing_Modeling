function plotAla2D_costillas_larguerillos(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas_larguerillos.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costillas_larguerillos.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_costillas_larguerillos.png')]);
    end
