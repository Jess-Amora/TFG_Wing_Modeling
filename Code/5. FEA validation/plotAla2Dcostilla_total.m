function plotAla2Dcostilla_total(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costilla_total.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_costilla_total.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_costilla_total.png')]);
    end
