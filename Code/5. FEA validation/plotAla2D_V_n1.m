...
% V_mass_comb = avion.weight_n1.V_mass_wing;
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig1, fullfile(avion.folder.figures, 'Plot_forces_V_nl.png'));
        saveas(fig1, fullfile(avion.folder.figures, 'Plot_forces_V_nl.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_forces_V_nl.png')]);
    end
