function plotAla2Dlarguerillo_total(avion)
...
% Flag graph
    ...
    if isfield(avion.folder, 'figures') && ~isempty(avion.folder.figures)
        ...
        saveas(fig, fullfile(avion.folder.figures, 'Plot_larguerillo_total.png'));
        saveas(fig, fullfile(avion.folder.figures, 'Plot_larguerillo_total.fig'));
        disp(['📊 Saved plot to: ', fullfile(avion.folder.figures, 'Plot_larguerillo_total.png')]);
    end
