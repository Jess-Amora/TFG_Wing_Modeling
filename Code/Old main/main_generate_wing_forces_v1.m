...
%% 🔹 Step 4: Select a Wing Construction Method Folder
disp('✈️  Select Wing Construction Method Folder:');

% ✅ Define the base directory where method folders are stored
...
%% 🔹 Step 5: Find and Execute `construirAla.m`
% ✅ Check if `construirAla.m` exists in the selected folder
...
%% 🔹 Step 4: Select a Wing & Fuselage Construction Method Folder
...
%% 🔹 Step 6: Find and Execute `construir_fuselaje.m`
