...
% Parámetros de entrada:
    ...
    nodos_anterior_ala_table = convert_nodes_front_spars_to_table_v2(nodos_posterior');
    nodos_posterior_ala_table = convert_nodes_rear_spars_to_table_v2(nodos_anterior');
