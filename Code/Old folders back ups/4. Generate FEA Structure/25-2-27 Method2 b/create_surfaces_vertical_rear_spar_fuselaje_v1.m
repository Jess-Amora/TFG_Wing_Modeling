function [quad_surfaces, warnings] = create_surfaces_vertical_rear_spar_fuselaje_v1(combined_nodes_3D)
    ...
    rear_spar_intrados = combined_nodes_3D(combined_nodes_3D.tag == 'rear spars fuselaje' & ...
...
node_1 = rear_spar_extrados(i, :);          % Bottom-left
node_2 = rear_spar_intrados(i, :)   ;          % Top-left
node_3 = combined_nodes_3D(combined_nodes_3D.rib_index == start_rib & ...
         combined_nodes_3D.tag == 'rear spars' & ...
         combined_nodes_3D.h == 'extrados', :);         
node_4 = combined_nodes_3D(combined_nodes_3D.rib_index == start_rib & ...
         combined_nodes_3D.tag == 'rear spars' & ...
         combined_nodes_3D.h == 'intrados', :);         
% Ensure nodes are not empty
if isempty(node_1) || isempty(node_2) || isempty(node_3) || isempty(node_4)
