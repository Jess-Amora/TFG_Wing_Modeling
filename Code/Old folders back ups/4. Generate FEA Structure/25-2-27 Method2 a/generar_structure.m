...
% function results = generate_structure(avion,datosEstructural,cargas,ala,fuselaje)
% close all
...
superficie_horizontal_larguero_posterior_3D_processed = process_quads_v1(combined_nodes_3D_processed,[superficie_horizontal_larguero_posterior_3D]);
write_bdf_quads_v1(fullfile(folder_parts,"\rear_spar_wing_horizontal.bdf"), superficie_horizontal_larguero_posterior_3D_processed, [], pshell_info, material_info);


quad_irregular_3D = preprocess_3D_quads(quad_irregular);
quad_irregular_3D_processed = process_quads_v1(combined_nodes_3D_processed,[quad_irregular_3D]);
write_bdf_quads_v1(fullfile(folder_parts,"\quad_irregular_wing_horizontal.bdf"), quad_irregular_3D_processed, [], pshell_info, material_info);
...
quads_regular_wing_3D_processed = process_quads_v1(combined_nodes_3D_processed,[quads_regular_wing_3D]);
...
quad_root_stringer = preprocess_3D_quads(quad_root_stringer);
...
quad_spars = preprocess_3D_quads(quad_spars);
