...
disp(['✅ Selected Aircraft Data: ', name_plane]);
    ...
    % ✅ Step 1: Select Structural Parameters
    structNames = fieldnames(TFG_Amora.datosEstructural);
    if isempty(structNames)
    ...
    structChoice = input('Select a structural parameter by number: ', 's');
    structIndex = str2double(structChoice);
    ...
    % ✅ Step 3: Create Aircraft-Structural Entry in `TFG_Amora.aviones`
    ...
    elseif strcmp(choice, '5')
      %% 🔹 Step 5: Add Structural Parts
        ...
        elseif strcmp(partChoice, '1')
            ...
            cordon_dims.hcl = hcl;
            cordon_dims.tcl = tcl;
            A_cordon = cordon(cordon_dims);  % Compute area
        ...
        elseif strcmp(partChoice, '2')
            ...
            % ✅ Compute area
            larguerillo_dims.type = type;
            larguerillo_dims.wf = wf;
            larguerillo_dims.tf = tf;
            larguerillo_dims.hw = hw;
            larguerillo_dims.tw = tw;
            larguerillo_dims.wh = wh;
            larguerillo_dims.th = th;
