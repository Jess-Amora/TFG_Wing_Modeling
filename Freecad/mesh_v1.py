...
def main():
    ...
    points_csv = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Project_Root\Code\output\points.csv"  # Replace with actual path
    elements_csv = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Project_Root\Code\output\lines.csv"  # Replace with actual path

    # Path to output STEP file
    step_output = r"C:\Users\jessa\OneDrive - Universidad Politécnica de Madrid\0. TFG 23-24\Project_Root\Freecad\output_model.step"  # Replace with actual path
